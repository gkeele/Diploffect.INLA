...
This package requires the [INLA R package](http://www.r-inla.org/), which is not available through CRAN. Visit the site, or more simply enter the following code at the prompt in R:
```r
